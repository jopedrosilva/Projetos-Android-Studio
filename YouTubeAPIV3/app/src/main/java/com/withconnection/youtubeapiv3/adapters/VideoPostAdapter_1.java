...
public class VideoPostAdapter_1 extends RecyclerView.Adapter<VideoPostAdapter_1.YoutubePostHolder> {

    private ArrayList<YoutubeDataModel> dataSet;
    private Context mContext = null;
    private final OnItemClickListener listener;

    public VideoPostAdapter_1(Context mContext, ArrayList<YoutubeDataModel> dataSet, OnItemClickListener listener) {
